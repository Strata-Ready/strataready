...
const SECTION_LEGISLATION: Record<number, { label: string; url: string }[]> = {
  ...
  5:  [{ label: 'Residential Tenancy Act', url: 'https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/02078_01' }, { label: 'RTB Policy Guidelines', url: 'https://www2.gov.bc.ca/gov/content/housing-tenancy/residential-tenancies' }],
