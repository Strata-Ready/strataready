...
const DEMO_QUESTIONS = [
  ...
  {
    id: 2,
    section: 'Residential and Commercial Tenancies',
    question_text: 'Under the Residential Tenancy Act, if a landlord gives a tenant a notice of end of tenancy for non-payment of rent, what must happen within 5 days of the tenant receiving the notice for the notice to have no effect?',
    option_a: 'The tenant must apply to the Supreme Court for an injunction',
    option_b: 'The tenant must pay the overdue rent or dispute the notice by applying for arbitration',
    option_c: 'The tenant must provide written reasons for non-payment to the landlord',
    option_d: 'The landlord must confirm receipt of any payment in writing',
    correct_answer: 'B',
    explanation: 'Section 46(4) of the RTA provides that within 5 days after receiving a notice for non-payment of rent, the tenant may pay the overdue rent (in which case the notice has no effect) or dispute the notice by applying for arbitration.',
    act_reference: 'Residential Tenancy Act, s. 46(4)',
  },
  {
    id: 3,
  ...
  {
    id: 4,
    section: 'Strata Properties and Cooperatives',
    question_text: 'A strata corporation wishes to pass a special levy and collect contributions from owners on a basis other than the Schedule of Unit Entitlement. What vote is required?',
    option_a: 'A majority vote at an annual or special general meeting',
    option_b: 'A 3/4 vote at an annual or special general meeting',
    option_c: 'A unanimous vote',
    option_d: 'An 80% vote at an annual or special general meeting',
    correct_answer: 'C',
    explanation: 'If the corporation intends to seek contribution on some other basis (other than the Schedule of Unit Entitlement), a unanimous vote is necessary.',
    act_reference: 'Strata Property Act',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    question_text: 'A strata corporation has been collecting tenant emergency contact information without obtaining explicit written consent. Under PIPA, which of the following best describes whether this practice is permissible?',
    option_a: 'It is not permissible because PIPA always requires written consent before collecting any personal information.',
    option_b: 'It is permissible because a tenant who supplies emergency contact information for use during their vacation would impliedly consent to the use of this information in the event of a future emergency.',
    option_c: 'It is permissible only if the strata corporation passes a bylaw authorizing collection of emergency contact information.',
    option_d: 'It is not permissible because emergency contact information is not considered personal information under PIPA.',
    correct_answer: 'B',
    explanation: 'A tenant who supplies emergency contact information for use during their vacation would impliedly consent to the use of this information in the event of a future emergency at the strata property. Implied consent is valid under PIPA where the purpose is clear and obvious to a reasonable person and the information is given voluntarily.',
    act_reference: 'Personal Information Protection Act (PIPA)',
  },
  {
    id: 8,
    section: 'Accounting Fundamentals',
    question_text: 'A strata corporation purchases a new boiler for $7,500, even though its current fair market value is $9,000. Under which accounting principle should the boiler be recorded at $7,500 in the financial statements?',
    option_a: 'Revenue recognition principle',
    option_b: 'Cost principle',
    option_c: 'Matching principle',
    option_d: 'Objectivity principle',
    correct_answer: 'B',
    explanation: 'The cost principle holds that when an entity acquires an asset, the asset\'s historical cost (the amount paid) is the appropriate amount to record, not the fair market value. In this example, the strata corporation paid $7,500, so that is the amount recorded.',
    act_reference: null,
  },
  {
    id: 9,
  ...
  {
    id: 10,
    section: 'Purchasing and Personnel Management',
    question_text: 'A strata manager receives two bids for a renovation project. The lower bid uses a "cost plus" pricing structure while the higher bid provides a fixed, all-inclusive price. Which of the following best describes the risk associated with the "cost plus" bid?',
    option_a: 'The cost plus bid guarantees that the final price will not exceed the initial estimate',
    option_b: 'The cost plus bid only becomes a guaranteed price after the contractor agrees in a contract that it is an all-inclusive price',
    option_c: 'The cost plus bid is legally binding as soon as the strata manager accepts it verbally',
    option_d: 'The cost plus bid eliminates the risk of extras being added throughout the work',
    correct_answer: 'B',
    explanation: 'Until an estimate becomes a legally binding promise (i.e., it becomes the fixed price in a contract), it cannot always be relied upon as the final price. It only becomes guaranteed after the contractor has agreed, in a contract, that it is an all-inclusive price.',
    act_reference: null,
  },
]
